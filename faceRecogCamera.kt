...
class faceRecogCamera : AppCompatActivity() {
    private val binding: ActivityFaceRecogCameraBinding by lazy {
        ActivityFaceRecogCameraBinding.inflate(layoutInflater)
    }
...
//        val message = "Image uploaded: ${SimpleDateFormat("yyyyMMdd_HHmmss", Locale.US)
...
//        sendData(message)
    ...
    private fun sendImagetoServer(imageByteArray:ByteArray, emailID:String){
        ...
        val request = Request.Builder()
            .url("http://192.168.1.14:5000/upload")
            .post(requestBody)
            .build()
                    ...
                    if (response.isSuccessful) {
                        ...
                        try {
                            ...
                            runOnUiThread {
                                ...
                                val intent = Intent(this@faceRecogCamera, dashboardView::class.java)
